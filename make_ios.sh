...
PROJECT_PATH=$PWD
OPENCV_BUILD="$BASEDIR/_build_ios/OpenCV_$OPENCV_VERSION_$IOS_ARCH"
DLIB_BUILD="$BASEDIR/_build_ios/DLib_$DLIB_VERSION_$IOS_ARCH"
...
xcodebuild ARCHS=$IOS_ARCH -target install -sdk iphoneos -configuration Release -parallelizeTargets -jobs 4
