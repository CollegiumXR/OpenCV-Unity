...
set OPENCV_BUILD=%PROJECT_PATH%_build_android\OpenCV
set DLIB_BUILD=%PROJECT_PATH%_build_android\DLib
set OPENCVEXTERN_BUILD=%PROJECT_PATH%_build_android\OpenCVExtern
